"""s09: extend the tool lifecycle with hooks and command policy checks.

The model and command handler are scripted so the example runs offline. Hooks
can observe, rewrite, block, or answer approval requests while exec policy
classifies commands independently from approval and sandbox enforcement.
"""
