"""s10: discover hierarchical AGENTS.md files and render project instructions.

The inherited agent runtime remains offline. This chapter adds a bounded,
source-aware loader for repository instructions from the project root to cwd.
"""
