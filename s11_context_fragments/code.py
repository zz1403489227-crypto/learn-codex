"""s11: assemble model context from typed, bounded fragments.

The inherited runtime remains offline. This chapter adds a small context
assembler that keeps developer and user fragments separate, tracks a durable
baseline, and emits only changed context on later turns.
"""
