"""s13: separate goals, collaboration modes, and update_plan checklists.

The inherited runtime remains offline. This chapter keeps the previous
context/skills runtime and adds a small contract layer: collaboration modes
shape what the agent may do, update_plan reports local progress, and thread
goals persist the user's long-horizon objective with budget accounting.
"""
